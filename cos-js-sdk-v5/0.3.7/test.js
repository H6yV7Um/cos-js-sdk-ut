var version = '0.3.7';
config.Bucket = 'js5ut' + version.replace(/\./g, '') + '-' + config.AppId;
var it = function (name, callback) {
    return QUnit.test.call(QUnit, name, function () {
        console.log('[testing] v' + version + ' ' + name);
        return callback.apply(QUnit, arguments);
    });
};
...
var getAuthorization = function (options, callback) {
    ...
    var authorization = COS.getAuthorization({
        SecretId: 'AKIDtgHguxSsaEykZHoIfqtlT1NY0MWTn4B5',
        SecretKey: 'rWyGVcXHpCjDOSMaheQSNGyMfstiOAqu',
    ...
    return new Promise(function (done) {
        ...
        cos.multipartInit({
            ...
            cos.abortUploadTask({
                ...
                var nameExist = false;
                forEach(data.successList, function (item) {
